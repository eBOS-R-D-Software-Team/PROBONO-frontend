...
const DubRoadDieselDatavis = () => {
  ...
  const handleFetch = () =>
    dispatch(fetchDubRoadDieselData({
  ...
  return (
    <div className="data-visualizations">
      ...
      <div className="breadcrumb">
        ...
        <SlArrowRight /> <span>Dublin – Road Diesel (DERV)</span>
      </div>
      ...
      {data.length > 0 && (
        <div className="visualization-container">
          <div className="table-graph-container">
            ...
            <ElectricityChart chartData={chartData} title="Road Diesel (DERV) – Selected Metrics" />
          </div>
          <Paginator
            first={first}
            rows={rows}
